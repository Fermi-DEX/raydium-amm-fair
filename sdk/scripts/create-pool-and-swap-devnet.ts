...
import { PublicKey as PublicKeyType } from '@solana/web3.js';
...
async function main() {
    ...
    const walletPath = 'raydium-test-wallet-devnet.json';
    ...
    fs.writeFileSync('raydium-test-tokens-devnet.json', JSON.stringify(tokenInfo, null, 2));
    console.log('💾 Token info saved to raydium-test-tokens-devnet.json');
    ...
    try {
        ...
        fs.writeFileSync('raydium-test-pool-devnet.json', JSON.stringify(poolInfo, null, 2));
        console.log('💾 Pool info saved to raydium-test-pool-devnet.json');
        ...
        fs.writeFileSync('raydium-test-swap-devnet.json', JSON.stringify(swapInfo, null, 2));
        console.log('💾 Swap info saved to raydium-test-swap-devnet.json');
        ...
        console.log(`  - Pool creation: https://explorer.solana.com/tx/${txId}?cluster=devnet`);
        console.log(`  - Swap: https://explorer.solana.com/tx/${swapTxId}?cluster=devnet`);
